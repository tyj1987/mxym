	...
	for( WORD i = 0; i < pMultiChangeItem->wMaxSet; ++i )
	{
		...
		if( pItemUnit )
		{
			...
			else
			{
				...
				{
					if(nMin > (pItemUnit->dwToItemDur/MAX_YOUNGYAKITEM_DUPNUM)) //���ذ� �ȵǴ� ������ ���� �ִ밪���� �۴ٸ�
					{
...
sCHANGEITEMUNIT* CChangeItemMgr::GetItemUnitFromCalPercent( WORD wItemIdx )
{
	...
	DWORD RandRate		= RandRateHigh*1000 + RandRateLow;	//(0 ~ 999,999)�鸸������
#else
