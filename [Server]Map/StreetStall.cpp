...
void cStreetStall::EmptyCell( ITEMBASE* pBase, eITEMTABLE tableIdx )
{
	...
	if( !m_sArticles[pos].bFill ) return; // �̹� ����� �ִ�..
...
{
	if( pos > MAX_STREETSTALL_CELLNUM ) return; // ������ �ʰ��Ѵ�??
	if( !m_sArticles[pos].bFill ) return; // ����� �ִ�..
...
void cStreetStall::ChangeCellState( WORD pos, BOOL bLock ) // (����)��ϰ��� �ٸ��� �迭�� �ε����� �Ѿ�´�.
{
	if(!m_pOwner) 
	{
		return;
