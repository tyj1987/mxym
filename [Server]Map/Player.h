...
#include "../[CC]Skill/skillobject_server.h"  // 添加CSkillObject定义
#include "ShopItemManager.h"
// 客户端库编译模式：不包含服务器版本的PetManager
...
class CPetManager;
class CTitan;
// 注意：CSkillObject 已在 skillobject_server.h 中定义，不需要前向声明
...
{
private:
	//2007. 12. 10. CBH - ��Ų ������ �ð� 10�� CPlayer������ ���⋚���� Ŭ���� �ȿ� enum���� ��Ҵ�.
    enum SKIN_DELAYTIME
	{
...
//
	...
	int m_initState;
	DWORD m_dwHpMpBitFlag;	// magi82 ����ġ���� ���� ȸ���ϴ� �÷��� 20% 40% 60% 80%
...
///////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////////////
	DWORD m_dwSkinDelayTime;	//2007. 12. 10. CBH - ��Ų��ü ������ �ð�
	BOOL m_bSkinDelayResult;	//2007. 12. 10. CBH - ��Ų��ü ������ ����	
	
	void SkinDelayTimeProcess();	//2007. 12. 10. CBH - ��Ų ������ �ð� ó��
	///////////////////////////////////////////////////////////////////////////////////
	...
	// magi82 - SOS(070720)
	int					m_SOSState;		// 0�̸� SOS ���� �ƴ�, 0�� �ƴϸ� SOS ����
...
//
	...
	// magi82 - UniqueItem(070629) - ������ ���̳ʽ��� �� ��� ����ó�� �߰�
...
//	void ObtainMoney(DWORD addmoney);		//���׿��� ��������� ȣ��
//	void SetMoneyNoMsgNoUpdate(DWORD money);
	...
	SET_ITEM_OPTION* GetSetItemStats()		{	return &m_setItemStats;		}	// 2007. 6. 12. CBH - ��Ʈ������ �ɷ�ġ ��ȯ �Լ� �߰�
...
//	BOOL HuntItemDBResult(DWORD dwPlayerID, ITEMBASE * itemInfo);
	...
	void SetMunpaMemberRank(BYTE rank){ m_HeroCharacterInfo.PositionInMunpa = rank; 	} //���Ŀ����� �ڽ��� ���� ����
...
public:
	void		SetDieForBattleChannel( BOOL bVal )	{	m_bDieForBattleChannel = bVal;	}	//��Ʋä�ο��� ���������� �׾��� �� �ش�. ��⳪ ��Ÿ battle���� ����.
	...
	// character attribute (�Ӽ�)
#ifdef _JAPAN_LOCAL_
//	DWORD	GetCharAttr()			{ return m_HeroCharacterInfo.dwCharacterAttr; }
	int		GetMainCharAttr()		{ return m_HeroCharacterInfo.nMainAttr; }		// �ּӼ�	
	int		GetSubCharAttr()		{ return m_HeroCharacterInfo.nSubAttr; }		// �μӼ�
	BOOL	ChangeMainCharAttr( int nMainAttr );
	BOOL	ChangeSubCharAttr( int nSubAttr );	
	int		WhatIsAttrRelation( int nOtherMainAttr );		// �Ӽ������?			
...
//	DWORD	GetMussangMaxPoint()		{	return m_HeroInfo.MaxMussangPoint;	}
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	void InitSkinDelay();			//2007. 12. 10. CBH - ��Ų��ü ������ �ð� ���� �ʱ�ȭ
	void StartSkinDelay();			//2007. 12. 10. CBH - ��Ų��ü ������ ����	
	BOOL GetSkinDelayResult();		//2007. 12. 10. CBH - ��Ų ������������ ��ȯ
	DWORD GetSkinDelayTime();		//2007. 12. 10. CBH - ��Ų ������ �����ð� ��ȯ
	/////////////////////////////////////////////////////////////////////////////////////////////////

	// AutoNote
#ifndef _MHCLIENT_LIBRARY_
protected:
	DWORD	m_dwAutoNoteAskPlayerIdx;		// 오토노트에서 요청한 사람
