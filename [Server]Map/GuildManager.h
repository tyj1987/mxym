...
class CGuildManager  
{
	...
	DWORD	m_CHECKTIMELEN_GuildHuntedMonsterCounter;	//  ͻīƮ DB ֱ
...
public:
	...
	void SendGuildName(CPlayer* pPlayer, DWORD dwGuildIdx, char * GuildName); // ban, secede, breakup ô Ⱥ.  ̸ Ƿ Ŭ̾Ʈ markchange 0  ó
	...
	//SW060526 â    
	void	SetGuildItemInfoInited(DWORD dwGuildIdx, BOOL bInit);	//ʱȭ  
	void	SendGuildItemInfoToAllWarehouseMember(DWORD dwGuildIdx);	//ʱ  Ŀ鿡  .
