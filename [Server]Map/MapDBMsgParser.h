...
//////////////////////////////////////////////////////////////////////////
// DB��I ��IAI ������AAo��| ����;�ҡ� ��������CO ID dAC
enum   DBMESSAGEIDFUNC 
{
	eNull,
	eCharacterInfoQuery,		/// CI����AC A����?d����������I��| ��o��i��A��U.
	eCharacterMugongQuery,		/// ����Ʃ�d������| ��o��i��A��U
	eCharacterItemSlotQuery,	
	eCharacterItemQuery,		/// ����AIAU d������| ��o��i��A��U
...
//	eJackpot_TotalMoney_Load,
	...
	ePyogukTitanEnduranceOptionQuery,	// magi82 - Titan(071015) â���� Ÿ��ź ��� ����
	...
	eCharacterSkinInfoUpdate,			//2007. 12. 10. CBH - ĳ���� ��Ų ����

	eCharacterUpdateResetStatusPoint,	// magi82(41) - �������� �߰�(���� �ʱ�ȭ �ֹ���)

	eCharacterSkinInfo,			//2008. 1. 23. CBH - ĳ���� ��Ų ����
...
#define STORED_CHARACTER_MUGONGINFO			"dbo.MP_CHARACTER_MugongInfo"				// ����Ʃ�d������| ����������A��U
...
//#define STORED_CHARACTER_MUGONGWEAR			"MP_CHARACTER_MugongWear"				// ����Ʃ�AaA����A CwI��An
//#define STORED_CHARACTER_GROUNDFROMSERVER	"MP_CHARACTER_ItemGroundDrop"			// ��E������i����i������ ����AIAU A���Ƣ�
//#define STORED_CHARACTER_MUGONGTOINVENTORY	"MP_CHARACTER_MugongToInventory"		// ����Ʃ�A�ˢ������� AI����Aa���硤I 
//#define STORED_CHARACTER_MUGINGDELETE		"MP_CHARACTER_MugongDelete"				// ����Ʃ���ef
...
//#define	STORED_CHARACTER_MUGONGUPDATE		"MP_CHARACTER_MugongUpdate"				// ����Ʃ�d���� �������AI����
//#define	STORED_CHARACTER_MUGONGMOVEUPDATE	"MP_CHARACTER_MugongMoveUpdate"			// ����Ʃ�d���� �������AI����
//#define	STORED_CHARACTER_CHARACTERUPDATE	"MP_CHARACTER_Update"					// A����?d���� �������AI����
...
/*
#define STORED_CHARACTER_ITEMUPDATE			"MP_CHARACTER_ItemUpdate"				// ����AIAU �������AI����
#define STORED_CHARACTER_ITEMTOTALUPDATE	"MP_CHARACTER_ItemTotalUpdate"			// AI���� ������c ����AIAU d���� �������AI����
#define STORED_CHARACTER_ITEMBUY			"MP_CHARACTER_ItemBuy"					// ����AIAU ��c��a
#define STORED_CHARACTER_ITEMINSERT			"MP_CHARACTER_ItemInsert"				// ����AIAU ��y����
#define STORED_CHARACTER_ITEMDELETE			"MP_CHARACTER_ItemDelete"				// ����AIAU ��ef
#define STORED_CHARACTER_ITEMDIVIDE			"MP_CHARACTER_ItemDivide"				// ����AIAU �������ϡ�a
...
//pjs ���ϡ�a���� AUCTION���� ��uCN AuAa CwI��An A���Ƣ� C������ CN��U..
//�Ʃ���A ��a��u�Ƣ� AO��AAo ��E��c 
#define STORED_AUCTION_CHECK		"dbo.MP_AUCTION_CHECK"
//A��AI��i�������� v��C ��E��oCO�ҡ� ���� CwI��An	//�������� �Ʃ���iAC ��o��| ������e��i���� ��U��U.
#define STORED_AUCTION_SEARCH		"dbo.MP_AUCTION_SEARCH"
//A��AI��i; v��C d��ACO�ҡ� ���� CwI��An	//�������� �Ʃ���iAC ��o��| ������e��i���� ��U��U 
...
//�Ʃ���A ��i��I,Ao����  Ae��O���� ���� CwI��An // �������� �Ʃ���iAC ��o��| ������e��i���� ��U��U
...
#define STORED_MUNPA_BREAKUP			"dbo.MP_MUNPA_BreakupMunpa" //���稡A������e ����AI
...
#define STORED_PYOGUK_TITAN_ENDURANCE_INFO	"dbo.MP_PYOGUK_Titan_Endurance_Info"	// magi82 - Titan(071015) â���� Ÿ��ź ��� ����
...
enum CHItemOptionInfo	// ����AIAU ��E��C
{
...
enum CPyogukItemRareOptionInfo	// ����AIAU ��E��C
{
...
enum CPyogukItemOptionInfo	// ����AIAU ��E��C
{
...
enum CMunpaItemOptionInfo	// ����AIAU ��E��C
{
...
{
	eGu_LMIdx, eGu_LMName, eGu_LMLevel, eGu_LMGuildIdx, eGu_LMRank, //ȣĪ �߰�
};
enum Guilcreate
{
...
enum eMapDropItem	// �� ��� ������ DB���� �߰� by Stiner(2008/06/05)-MapDropItem
{
...
//SW060719 ��������Ʈ
//void GuildHuntedMonsterCountLastDBUpdateDate(WORD MapNum);	//�� ���� ���ý� ���� �������� ������ m_wCurDateCheckForConverCount �����Ѵ�.
//void RGuildHuntedMonsterCountLastDBUpdateDate();	
void GuildLoadGuildPointInfo(DWORD startGuildDBIdx);	//����������� ����DB�ε���
...
void GuildAddHuntedMonsterCount(DWORD GuildIdx, DWORD MonsterCount);	//10�� ���� ���� ����
void GuildGetHuntedMonsterTotalCountWithInit(DWORD GuildIdx);	//���� ���� ��������Ʈ�� ����
...
void GuildAddGuildPoint(DWORD GuildIdx, DWORD rAddPoint, DWORD rAddKind, DWORD rAdditionalData);	//���� ����Ʈ �߰� r# �״�� ���Ϲ޾� �� ����
...
//SW070103 ��������Ʈ����	//���ϻ� ������ ���� ����Ʈ ����. ���ϱ�
void GuildStudentLvUpCtUpdate(DWORD GuildIdx, DWORD AddPoint, DWORD ToPoint);	//AddPoint - ������, ToPoint - ����
...
void PyogukTitanEnduranceInfo(DWORD CharacterIdx, DWORD UserIdx, DWORD StartDBIdx);	// magi82 - Titan(071015) â���� Ÿ��ź ��� ����
