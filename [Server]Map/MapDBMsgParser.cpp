...
#include "QuestManager.h"
#include "GuildManager.h"	// magi82 - ���ϻ�����(070123)
#include "PackedData.h"

#include "ItemLimitManager.h"
#include "FortWarManager.h"

#include "MapItemDrop.h"	// �� ������ ��� �߰� by Stiner(2008/05/29)-MapDropItem
#include "ServerSystem.h"

//taiyo 
//sprintf %d����I AeAI��iC��ui AO�ˡ�A ����A ��uod!!!! ��oo�������� /��o�ϡ�!!
//��i��IAIAI A�ˡ�AO������������I ��uod!

extern BOOL g_bPlusTime;


//////////////////////////////////////////////////////////////////
// DB����I����IAI �ˡ�������oAAo�ˡ�| ��i����i����u������u���� �����ˡ���������CI�ˡ�A CO��uo��ie.
DBMsgFunc g_DBMsgFunc[MaxQuery] =
{
	NULL,
	RCharacterNumSendAndCharacterInfo,		/// CI�ϩ�����AC A�ϩ��ˡ�?d�����ˡ��ˡ��ϡ̡�iI�ˡ�| ��uo��ui��?A�ˡ�U.
	RCharacterMugongInfo,		/// ��o��i�����Ϩ�d�����ˡ��ˡ�| ��uo��ui��?A�ˡ�U
	RCharacterItemSlotInfo,					// eCharacterItemSlotQuery
	RCharacterItemInfo,		/// ��u����AIAU d�����ˡ��ˡ�| ��uo��ui��?A�ˡ�U
...
//	NULL,				/// ��o��i�����Ϩ���ief
	RMapBaseEconomy,				/// ����aA������oA��u��uC��IAo�ˡ���c
	NULL,				/// �����Ϣ��ˡ�A��ii����ICwI��oAn
	NULL,			/// A�ϩ��ˡ�?d�����ˡ� ��u��%i��IAI������c
...
//	NULL,	//	RJackpotLoadTotalMoney,				// eJackpot_TotalMoney_Load
	...
	// �� ������ ��� �߰� by Stiner(2008/05/28)-MapItemDrop
...
//////////////////////////////////////////////////////////////////
// DB����I Query��o��c; �ϩ�?�ˡ�������O���� ��u�ϡ��ˡ�A CO��uo��ie.
//pjs
//�����Ϣ��ˡ�A ����a����u�����ˢ� AO�ˡ�AAo ����E��ic 
char txt[512];	//�����Ϩ�Ae ��ic��?e
...
//�ˡ���c��i����i��������c ����E��io ��i��|i����oy; CASE��o��c8����I..
...
/* dwKey��������: DB��?�ˢ� ��io����I �ϩ�O; ItemAI ARRAYAC �ϩ��ˢ� ItemAIAo��?I ArrayIdx�ˡ�| �ϩ�O�ˡ�A�ˡ�U.
   CI�ϩ�����AC ARRAY�����ˢ� DB��?�ˢ� �ˡ��ϡ̡�iI �����ˡ���u���� ��iC��uu;��O�����ˡ��ˡ� �ˡ�U= AU��u��A; ��uoCaCI����a'C������u���� CE��?a
   0AI�ˡ�e ~����a �ϩ����̡ˡ�OAo�ˡ�A ����e��uO A�Ϩ�Ca (������o��uo�ˡ�| C��I��oACI����a��i��i CN�ˡ�U.)
...
// --------------------------------------------------------------------------------------------------
// taiyo code
// CharacterDupItemInsertAC wKey�ˡ�A RCharacterDupItemInsert��?�ˢ硧u���� E��IAaAU�ˡ�| �����ˡ���������CI����a 'CN �����ˡ���������AUAI�ˡ�U
// 0����u 0AI��?UAC ��������; ��ic��?eCI�ˡ�A BOOL��������AC CuAA�ˡ�| AeCN�ˡ�U
/*
...
void MunpaLoad(DWORD MapNum, DWORD StartMunpaID) // �ˡ�E��u���Ϩ�oo�����ˢ� ANs; ��O���� ��o��c����A d�����ˡ� ��i����i����u������?E
{
//	char txt[128];
...
void MunpaLoadSyn(DWORD PlayerID, MAPTYPE MapNum, DWORD GotoPage, DWORD PageUnit, char* OrderType) //A������OoAI��u�ϡ̡�����c��?�ˢ硧u���� ��?aA��iAI AO; ��O����
{
...
void MunpaBoardFrontContent(DWORD PlayerID, DWORD BoardIdx, DWORD StartContentID, DWORD MyMunpaRank)
{
	g_DB.FreeLargeQuery(RMunpaBoardReadContent,PlayerID,
		"EXEC %s %d, %d, %d, %d, %d",  STORED_MUNPA_BOARDREADCONTENT, 
		BoardIdx, StartContentID, 0, MyMunpaRank, PlayerID); //0: �ˡ�U=����U
}
...
void RGuildItemLoadInNeed( LPQUERY pData, LPDBMESSAGE pMessage )
{
	...
	{
		// SLOT_GUILDWAREHOUSE_NUM < MAX_QUERY_RESULT �̰��� ���� �� ����.
...
void CharacterMugongInfoUpdate(CPlayer* pPlayer)
{
	...
	// magi82(2) - Titan(071022) Ÿ��ź ���� ����ġ DB �����ϴ� �κ�
...
//////////////////////////////////////////////////////////////////
// DB����I����IAI �ˡ�������oAAo�ˡ�| ��i����i����u������u���� A�ϩ��ˡ���cCI�ˡ�A CO��uo��ie.
...
void RCharacterNumSendAndCharacterInfo(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if(!count)
	{
		// A�ϩ��ˡ�?AI d�����ˡ���i����i������a ��oC�������ˡ�?7u
		ASSERTMSG(0,"DB��?�ˢ� AE�ˡ�?AI ��i��IAIA�ˡ������ˢ� ��u�Ϩ���o4I�ˡ�U.");
		return;
	}
	...
	// UserIDX�ˡ�A �ϩ�N����aAo ��uE�ˡ�A�ˡ�U
	...
	if(!CheckBit(Heroinfo.ExpFlag, 4))
	{
		...
		SetOnBit(&Heroinfo.ExpFlag, 4);	// �ѹ� ���� �Ǿ����Ƿ� �������� ���� ����
		UCharacterExpFlag(Objinfo.dwObjectID, Heroinfo.ExpFlag);	// �۾��� DB����
	}
...
void	RCharacterItemInfo(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	else
	{
		...
		// Player��?�ˢ� ��u����AIAU d�����ˡ�A�ϡ������ˢ�
		pPlayer->InitItemTotalInfo(&Iteminfo);
		ShopItemInvenInfo( pPlayer->GetID() );

		// �ϩ�eaA��E��?�ˢ� �ϩ��ϡ���u���� AO�ˡ�A ��u����AIAU; AI������IAa�ˡ���c����I ��?A����a�ˡ�U???
		// ��?i��u���� AO��u��c A�ϩ��ˡ���c : taiyo 
...
void RPyogukItemOptionInfo(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	//SW051007 PyogukItemRareOptionInfo �� �ű�.
//	else
//		CharacterPyogukItemInfo(pMessage->dwID, 0);
}
...
void	RCharacterItemOptionInfo(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	{
		ASSERTMSG(pMessage->dwResult <= 90, "Item Option > 90 Error : ��oI��?i; ����O����?�����ˡ���u������?a~!");
	...
	{
		ASSERTMSG(count <= 90, "Item Option > 90 Error : ��oI��?i; ����O����?�����ˡ���u������?a~!");
	...
	if(atoi((char*)pData[0].Data[ePIII_DBIDX]) != 0)
	{
		for( DWORD i = 0; i < pMessage->dwResult; ++i )
		{
			...
			if(TP_PETINVEN_START <= ItemPos && ItemPos < TP_PETINVEN_END)
			{
				...
				//PetInvenItem.PetInven[ItemPos].QuickPosition = 0	//(��ȹ))���κ� �������ȵ�
...
void RSSItemInsert(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	{
		// Insert ��u���������Ϩ�
		DWORD dwPlayerID = atoi((char*)pData->Data[eCI_ObjectID]);		// A�ϩ��ˡ�?��u����AI��i�ϡ�
		ITEMBASE info;
...
void	RCharacterItemGetDivideIDX(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	{
		// Insert ��u���������Ϩ�
		atoi((char*)pData->Data[eCI_ObjectID]);		// A�ϩ��ˡ�?��u����AI��i�ϡ�
...
void RItemRareInsert(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if( pMessage->dwResult )
	{
		...
		pItemArrayInfo->ItemArray.AddItem( atoi((char*)pData->Data[eCIR_ItemDBID]),	//���� ������ DB �ε���
							atoi((char*)pData->Data[eCIR_ItemIdx]),	//���� ������ ����Ʈ �ε���
							0,	//atoi((char*)pData->Data[eCIR_Durability]),	//����(��ȭ�ε���)
							atoi((char*)pData->Data[eCIR_Position]), //�κ� ������
							0,	//atoi((char*)pData->Data[eCIR_QPosition]),	//����â ��ġ��
							0,	//atoi((char*)pData->Data[eCIR_Param]),
							atoi((char*)pData->Data[eCIR_RareID])	//���� DB �ε���
							);	
		
		ITEM_RARE_OPTION_INFO RareOptionInfo;

		RareOptionInfo.dwRareOptionIdx				= (DWORD)atoi((char*)pData[0].Data[eCIR_RareID]);	//!��� ���� �ȸ��� �ɵ�
...
void RItemInsert(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if( pMessage->dwResult )
	{
		...
		{
			//��u�����ˡ�O��O�����ˡ�A ��ui��O��i����O A�ϩ��ˡ���cCO����IAI�����ˢ�?
			//A������OoAI��u�ϡ̡�����c AI������IAa�ˡ���c�����ˢ� �ˡ�����A�ϡ��ˡ�A��i��I.. �ˡ�������oAAo�����ˢ� ��u�Ϩ���ui��u����.
		}
	}
	else
	{
...
void RMunpaLoad(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	{
		// �ϩ��ϡ���u����AO�ˡ�A ��o��c����A�����ˢ� �ˡ�o AO8�ˡ�I �ˡ�U��oA �ˡ���c��i����i��������c�ˡ�| ��i����i����u������?A�ˡ�U.
...
void RMunpaCreate(LPLARGEQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if(!munpa.MunpaID)
	{
		ASSERTMSG(0, "��o��c����A�ˡ�| ��iy��u����C�ϡ��ˡ�A��i��I ��u����AI��i�ϡ̡ˡ�| A�ϡ��ˡ��Ϩ� ��i����i����u������?O��o4I�ˡ�U.");
		return;
	}
...
void RMunpaBreakUpMembers(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	for(DWORD i=0; i<pMessage->dwResult; ++i)
	{
		//����I�������� ��u������?o CO��O���� MP_CHARACTER_TotalInfoUpdated ��?�ˢ硧u���� 
		//tb_munpaA����AI����i; Au����iC������u���� ��u��%i��IAI������cCI�ˡ�e��u���� A����AI����i d�����ˡ��ˡ�| AIA�ˢ硧oAA�ϡ��ˡ�U. 
		MemberID = atoi((char*)pData[i].Data[eMu_MBmemberid]);  //��?A��OoAI ��iC��ui AO�ˡ�A �ˡ�a��oo�ˡ��ˡ� �����ˡ��ϩ���iA�����ˡ�U.
	...
	{
		//A�ϩ��ˡ�?AI A����AI����i��?�ˢ� AO�ˡ�A ��i��IAIA�ˡ��ˡ�| Ao��?i�ˡ�U.
...
void RMunpaChangeMemberRank(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if(atoi((char*)pData->Data[eMu_MCRchangeerr]) != 0) //����?�����Ϣ� �ˡ��Ϩ�C�ϡ�=.
	{
	...
	{
		//�ˡ��ϡ̡�ic ��?�ˢ�AIAu������c����I �����ˡ��ϩ���i��u���� AO8�ˡ�e ��?��������a��iE �ˡ�E��u���Ϩ�oo����I �����ˡ��ϩ���o�ˡ�U. 
...
{	
	...
	//A�ˡ�����U CA������oAI��ui�����ˢ� ��?A��OoAI ��iC��uiAO8�ˡ�e ��u����AI��i�ϡ̡ˡ�| ��u�����ˡ�I�ˡ�e 0; �ˡ���cAICN�ˡ�U. 
	DWORD TargetID = atoi((char*)pData->Data[eMu_MACtargetid]);
	if(TargetID != 0) //��?A��OoAIAI��i��I
	{	
		CPlayer* pTargetPlayer = (CPlayer*)g_pUserTable->FindUser(TargetID); 
		if(!pTargetPlayer) //AI �ˡ�E��u���Ϩ�oo��?�ˢ� ��u�Ϩ�8�ˡ�e ����e����I��iaA�ϩ���i����i������A
		{
...
void RMunpaBoardReadContent(LPLARGEQUERY pData, LPDBMESSAGE pMessage)
{
	...
	{
		DWORD ErrorCode;
		// ����O��oA��o����AI xAcCIAo ��uE����A�ϩ����� ��ief��iC��uu��o4I�ˡ�U.
		if(err==1)
...
void RCharacterPyogukItemInfo(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	if(pMessage->dwResult < MAX_MUNPALOAD_LIST) //��u����AIAU; ��ui��O��i����O �ϡ���(ui��?AAo? 100�����ϩ�
	{
		...
		if(UserIDX == 0)
		{
			...
			fprintf(fp, "CharacterPyogukItemInfo��?�ˢ硧u����  UserIDX : %d ", atoi((char*)pData[0].Data[ePyo_Userid]));
...
void RUsingShopItemInfo( LPQUERY pData, LPDBMESSAGE pMessage )
{
	...
	for(DWORD i=0; i<pMessage->dwResult; i++)
	{
		...
		{
			memset( &msg.Item[msg.ItemCount], 0, sizeof(SHOPITEMBASE) );	//Ŭ���̾�Ʈ�� �޼��� ���ʿ䰡 ����.
		}
...
void RGuildLoadGuild(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	else
	{
		GuildLoadNotice(0);
		GuildLoadMember(0);
		// RaMa - Guild Tournament - Guild���� �о�� �Ŀ� �д´�.
...
void RGuildLoadMark(LPLARGEQUERY pData, LPDBMESSAGE pMessage)
{
	...
	//	g_pServerSystem->SetStart(TRUE);
		...
		//SW060526 ����â�� ������ �������� ���� ����
		//GuildItemLoad(GAMERESRCMNGR->GetLoadMapNum(), 0);	//���� ���ν����� �д�. //GuildItemOption(.. //GuildItemRareOption(..
...
void RGuildItemOption(LPQUERY pData, LPDBMESSAGE pMessage)
{
	...
	//SW051007 RGuildItemRareOption ���� �ű�.
//	else
//	{
////		g_pServerSystem->SetStart(TRUE);
//		
...
//	if(!pPlayer)		return;
	...
	JACKPOTMGR->SetPrizeInfo( TotalMoney, PrizeMoney, PlayerID, PrizeKind ); //�ΰ��� �����Ѵ�. �ش� ID�� PrizeMoney��ϰ� ������ ����
}
...
/// �� ��� ������ �߰� �۾� by Stiner(2008/05/28)-MapDropItem
