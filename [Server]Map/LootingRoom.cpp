...
//---SuperUser(�ܺο� ������ ĳ���Ͱ� PK�� ���ô����� �ʰ� �ϱ�����), GM �� �����ڴ� ���ô����� �ʴ´�.!!!!! ^___^
//	if( pDiePlayer->GetUserLevel() > eUSERLEVEL_SUPERUSER )	//�׽�Ʈ�� ���� �����ߴ�. �츮��.
	{
		//��OA�� ACC���� ��AIAU A���o �O��a
	...
	m_dwLootingStartTime = gCurTime;	//�i�� ��ACN��U.
...
{	//�A�ơ�A�A��
	if( gCurTime - m_dwLootingStartTime > PKLOOTING_LIMIT_TIME + PKLOOTING_DLG_DELAY_TIME + 3000 )	//3AE ��oA����U. ���ˢҡ���.
		return TRUE;
...
BOOL CLootingRoom::Loot( int nArrayNum, BOOL bForce )
{
	...
	if( fDist > PK_LOOTING_DISTANCE + 500 )	//�ϡ�a �AA���| { ��oC���� �졾i?
	{
		if( !bForce )
		{
	...
	if( m_LootingItemArray[nArrayNum].nKind == eLI_ITEM )	//��AIAU AO��a!
	{
		//////////////////////////////////////////
		//AttackPlayerAC AI����Aa�� AU��� AO��A��?
		...
		{
			/////////////////////////
			//DiePlayer ��AIAU Ao�i��a - Au����Ao�C��u �E�C��AIAU: A����oAI����碡� Ao�i�e ��E��U.
	...
	else if( m_LootingItemArray[nArrayNum].nKind == eLI_MONEY )		//�졤AO��a!
	{
		...
		MoneyMsg.dwData2	= nArrayNum;	//byte��I A����CI��aCN���
	...
	else if( m_LootingItemArray[nArrayNum].nKind == eLI_EXP )		//��CeA AO��a!
	{
		...
		ExpMsg.dwData2	= nArrayNum;	//byte��I A����CI��aCN���
