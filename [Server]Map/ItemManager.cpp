...
int CItemManager::MoveItem( CPlayer * pPlayer, WORD FromItemIdx, POSTYPE FromPos, WORD ToItemIdx, POSTYPE& ToPos)
{
	...
	if(pInfo->ItemKind & eTITAN_EQUIPITEM)
	{
		...
		//2007. 10. 25. CBH - Ÿ��ź ��� ����� �������� üũ (ǥ�� �̵��� �������� üũ�� ���Ѵ�)
	...
	{
		// Ao��?i����tA ��u����AIAU(FromPosition)AI ��u����ˡ�U 
		return 5;
	}
	...
	// DB��?��� DBIndex����I d�����ˡ� update
	// position�ˡ��ˡ� ����?E���ϡ�iE�ˡ�U
	// ToItemBase->dwDBIdx == 0 AI�ˡ�e ToItem: ��uE��oU�ϡ�U�ˡ�U.
	if(TP_GUILDWAREHOUSE_START <= FromPos && FromPos < TP_GUILDWAREHOUSE_END)
	{	//RemoveGuildItemOption ����ɼǵ� ���� ���ش�.
		RemoveGuildItemOption(ToPos, pToSlot->GetItemInfoAbs(ToPos), pPlayer);
	}

    // 06.12.06 RaMa - �����γ��� �������� ĳ���ͻ�������� �ٲ�� ����
	...
	if( ToPos == 81 )
	{
		...
		{
			// magi82(12) - Item(071026) �̺�Ʈ����(�и�ġ, ����尩 ��) ����ó���� ����. �����ָ� �޸� �浹�� �Ͼ
...
//	CItemSlot * pSlot = pPlayer->GetSlot(eItemTable_Inventory);
	...
	ITEMBASE NewItemBase;  /* AI�ˡ�U ��u��i��?i����o����a��������8����I ��uA����A */
	NewItemBase.dwDBIdx			= 9;
	NewItemBase.wIconIdx		= 9;
	NewItemBase.Position		= 9;
	NewItemBase.QuickPosition	= 9;
		...
		for( i = 0 ; i < EmptyCellNum ; ++i )
		{
			...
			{				
				if( pItemBase->Durability + obtainItemNum > MAX_YOUNGYAKITEM_DUPNUM )
				{
					...
					// '��?�ˢ硧u���� UpdateCI�ˡ�A ��u���������I��?��� ��������AI ��oU�ϡ�i����i 
...
// rt : ��uOAoCN ��i����8����I ��ii ��uo AO�ˡ�A �����ϩ���uo
WORD CItemManager::GetCanBuyNumInMoney(CPlayer * pPlayer, WORD buyNum, MONEYTYPE Price)
{
	MONEYTYPE money = pPlayer->GetMoney();

	if( money >= (MONEYTYPE)(buyNum * Price) )	//buynum��?��� ��u��i��?i����o����a��������(�ˡ�A��?iA��i��������)AI ��ie��ui�����ˢ硧u����...��o��cf������� ��iy����aAuAI AO�ˡ�U.
	{
		return buyNum;
	}
	else
	...
	if(pItemInfo->ItemKind & eYOUNGYAK_ITEM)
	{
		...
		if(pItemInfo->LifeRecover>0)
		{
			...
			if( (pPlayer->GetAvatarOption()->RecoverRate) || (pPlayer->GetSetItemStats()->fLifeRecoverRate) )
			{
				...
				// 0.01f�� ���� �ʰ� 0.01�� �� ������ 0.01f�� float ������ �ϸ� 0.01�� �ƴ϶� 0.0099999998�� �ǹǷ� ��Ȯ�� ���� �ȳ��´�.
				// 0.01�� �ϸ� 0.10000000000000001 �� ����Ǿ� �������� ���� ���´�.
		...
		if(pItemInfo->NaeRyukRecover>0)		//�ϩ���i����A+(E�ˡ�������o) ����id��uoA���	 
		{
		...
		if(pItemInfo->NaeRyukRecoverRate>0)		//�ϩ���i����A+(E�ˡ�������o)%
		{
...
//�׸��� ��ü�� ������
	...
	else if(pItemInfo->ItemKind & eEXTRA_ITEM)
	{
		...
		{
			pPlayer->SetEventSnowIdx(pItemInfo->ItemIdx);	//��ũ ������ �ȵȴٺ��� �ʱ�ȭ ���ϰڴ�.
		}
		// ��ii����������u��A ����n����������u���� ��ic��?e
		if(EI_TRUE != DiscardItem(pPlayer, TargetPos, wItemIdx, 1))
		{
...
/*
(1)	��o��i����a / ��i��|i����ui�����ˡ� / ��u������u��u��u���ϡˡ���c : [fv ��u����������� E��c����u] + [����?����a��ii��������]
(2)	����������?U : [fv ��u����������� E��c����u] + [����?����a��ii��������] * 2
(3)	����Cd
�������)	��u����������� : [��u����������� E��c����u] < random(0~100)
�ϩ�����)	��oC�������� : [��u����������� E��c����u] > random(0~100) AI����i ��u�����������E��c����u - random(0~100) < 30
�ˡ�U)	�ˡ�e��oC�������� : [��u����������� E��c����u] > random(0~100) AI����i ��u�����������E��c����u - random(0~100) > 30
// Ac����a ��ief : ��u�����������, ��oC��������, �ˡ�e��oC��������
// ����a������i��u����AIAU ��ief : ��u�����������, �ˡ�e��oC��������
*/
...
{
	// magi82 - Titan(070403) Ÿ��ź�� �����Ҷ��� ���ս�ų�� ������� üũ���� �ʴ´�.
	if(!bTitan)
	{
...
//	eITEM_KINDBIT bits = GetItemKind(pMixInfo->wItemIdx);
	...
	// +10�� ���� ��� �߰� �۾� by Stiner(2008/06/13)-10+MixItem
	// pMixInfo�� �������� ������� +10�ϰ�� ���շ� ����� �ٸ� ������ �� �ش�.
	...
	CItemSlot * pSlot = pPlayer->GetSlot(0); //�κ����״�
...
//---��ȭ�� ��� ������ ���� üũ
	...
	int eOptKind = eIOK_Normal;	//Ÿ�� �������� �ɼ� ����. �Ϲ�(��ȭ)/����

	if(IsRareOptionItem(pTargetItemBase->wIconIdx, pTargetItemBase->RareIdx))	//���� ��ȭ�� ���
	{
		eOptKind = eIOK_Rare;
	}
	...
	for( i = 0 ; i < wJewelNum ; ++i)
	{
		...
		if( REINFORCEMGR->CheckValidMaterial( pTargetItemBase->wIconIdx, pJewelItemBase->wIconIdx, eOptKind ) == FALSE )	//@��� �������� ��ȭ �ɼǿ� �´� ������� Ȯ��
		{
			return 8;
		}

		if( REINFORCEMGR->CheckMaterialTotalGravity( pJewelItemBase->wIconIdx, (WORD)pJewelItemBase->Durability, eOptKind) == FALSE )	//����� �Ѻ����� üũ
		{
			return 20;
		}
	...
	REINFORCEMGR->InitGravity();	//���� üũ ����� �Ѻ��� 0 �ʱ�ȭ.
...
//		ITEM_REINFORCE_INFO * pReInforceInfo = GetReinforceItemInfo(jewelExInfo[i].wItemIdx);
		...
		//SW051021
		sITEM_REINFORCE_INFO* pReInforceInfo = NULL;		//pReInforceInfo SW�̰� ������ ����;
...
//		float plusValue = (float)wAvgValue * pReInforceInfo->fMaxReinforce / 50.0f;
		...
		if( plusValue < 1.0f )	plusValue = 0.0f;	//SW060628 �Ӽ�������.. 
#endif
...
void CItemManager::ReinforceItemDBResult(CPlayer * pPlayer, WORD wItemIdx, POSTYPE TargetPos, ITEM_OPTION_INFO * pOptionInfo)
{
	...
	{
		ASSERTMSG(0, "��oI��?i; ����O����? �����ˡ���u������?a!-��u����AIAU ��������E���� PREINSERT��iE ��u����AIAU��?��� dura update ��?�ˢ���?");
		return ;
	}
...
//	}
	...
	//SW070821 ���� ItemInfo->Durability => ItemInfo->RareIdx,
	LogItemMoney(pArrayInfo->dwFurnisherIdx, "", pPlayer->GetID(), pPlayer->GetObjectName(),
...
int CItemManager::UpgradeItem(CPlayer* pPlayer, WORD & TargetItemIdx, POSTYPE TargetPos, WORD MatItemIdx, POSTYPE MatItemPos)
{
	...
	// ��ii��������AI 30����iAo ��?8��I����a��O������o��i��?��� *10->*5����I ��oU�ϡ�����.
	...
	{
		// ��u����AIAU ��ui����o�ˡ���c������u ��ii��������AI ��iy����a����i �ϩ����̡�u���� ����IAI >3 �����ˡ��ˡ�U A��i����O �ϩ����̡�?E
		// IF > 3 , then = 3
		gradeUp = 3;
	}
...
{
	// ItemIdx�ˡ�A ��oI�ˡ���c A���ˡ�uiAa��u�ϡ�CO
...
//	strcpy(pInfo->ItemName, pFile->GetString());
	...
	pInfo->wSetItemKind = pFile->GetWord();	// 2007. 6. 7. CBH ��Ʈ�̾��� ���� �߰�
}
...
{	
	...
	{
		char buf[128];
		sprintf(buf, "�����忡�� ������ �޽����� ���½��ϴ�. character_Idx: %d, Protocol : %d", pmsg->dwObjectID, pmsg->Protocol);
		ASSERTMSG(0, buf);
		return;
	}
...
JobChangeFailed:
	...
	//		// TITANITEMMGR->TitanMugongChange(pPlayer, pmsg);	// magi82 - Titan(070611) Ÿ��ź ������ȯ �ּ�ó��
	//	}
	//	break;
		// magi82 - Titan(070413)
...
UniqueItemCurseCancellation:
	...
	case MP_ITEMEXT_UNIQUEITEM_MIX_SYN:
		...
		break;
	case MP_ITEMEXT_SKINITEM_SELECT_SYN:	//2007. 12. 5. CBH - ��Ų ������ ó��
		{
			MSG_DWORD2* pmsg = (MSG_DWORD2*)pMsg;
			CPlayer* pPlayer = (CPlayer*)g_pUserTable->FindUser(pmsg->dwObjectID);
			if( pPlayer == NULL ) 
			...
			if(pmsg->dwData1 > 0)	
			{
				...
				{
					pPlayer->InitSkinDelay();	//��Ų ������ �ð� �ʱ�ȭ
					pPlayer->StartSkinDelay();	//��Ų ������ ����
				...
				else
				{
					...
					msg.dwData2 = pPlayer->GetSkinDelayTime();	//���� ������ �ð�
					msg.dwData3 = pSkinInfo->dwLimitLevel;

					pPlayer->SendMsg(&msg, sizeof(MSG_DWORD3));
				}
			}
			else if(pmsg->dwData1 == 0)	//������� ��ư Ŭ���� ó��( pmsg->dwData ���� 0�̸� ������� )
			{
				pPlayer->InitSkinDelay();	//��Ų ������ �ð� �ʱ�ȭ
				pPlayer->StartSkinDelay();	//��Ų ������ ����
...
BOOL CItemManager::CanMovetoGuildWare(POSTYPE FromPos, POSTYPE ToPos, CPlayer* pPlayer)
{
	...
	//�ˡ�U�ˡ���IA��E��?�ˢ硧u���� ��o��c����AA��E8����I AI��i��?CO��O����
	if(TP_GUILDWAREHOUSE_START <= ToPos && ToPos < TP_GUILDWAREHOUSE_END)
	{
		//ToPos��u����AIAUAI AO8�ˡ�e AI��i��? �ˡ����CO
		if(!pToSlot->IsEmpty(ToPos)) 
			return FALSE;
		return TRUE;
	}
...
//			return FALSE;
	...
	else if(TP_TITANWEAR_START <= pos && pos < TP_TITANWEAR_END)
	{
		...
		if( pInfo->ItemKind & eTITAN_EQUIPITEM )
		{
			if(pos - TP_TITANWEAR_START == pInfo->ItemKind - eTITAN_EQUIPITEM_HELMET)	// ������ �̰� ��������~~
				return TRUE;
		}
		return FALSE;
	}
...
BOOL CItemManager::ItemUnsealing(CPlayer* pPlayer, POSTYPE absPos)
{
	...
	if( pItemBase->ItemParam & ITEM_PARAM_SEAL )
	{
		...
		if( pItemInfo )
		{
			...
			//SW051129 Pet
			/*
			if( pItemInfo->ItemKind == eSHOP_ITEM_PET )	//GM Cheat �� ���� �����۸� �� �����ۿ� ���δ�.
			{	//���� ������ ù ����.
				//��! ����� �����ϹǷ� ���� �� ���� Ȯ��
				//�� ID ���( ���Ϲ��� DBID + PET_ID_START )
	...
	else	// �Ҹ��϶�.
	{
		...
		for( WORD i = 0; i < pmsg->slotNum; ++i )
		{
			...
			if( eItemUseSuccess == rt )
			{
				MSG_ITEM_USE_ACK msg;
				msg.Category = MP_ITEM;
				msg.Protocol = MP_ITEM_USE_ACK;		//MP_ITEM_DISCARD_ACK �� ���� ������ �ȵǾ� �ߺ� �������� �䱸�������� �� �������ϴ�.
...
WORD CItemManager::ObtainItemFromGameEvent( CPlayer* pPlayer, DWORD dwItemIdx, WORD wItemNum )
{
	...
	CItemSlot* pSlot = NULL;
	WORD wSeal = 0;
	if( pItemInfo->ItemKind & eSHOP_ITEM )	// ��� �������� shopitem�̳�?
	{		
		pSlot = pPlayer->GetSlot(eItemTable_ShopInven);
		wSeal = 1;
	}
