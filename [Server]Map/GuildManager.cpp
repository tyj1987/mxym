	...
	case MP_GUILD_HUNTEDMONSTER_TOTALCOUNT_TO_MAP:
		{
			...
			SetGuildHuntedMonsterTotalCountInfo(pmsg->dwObjectID, pmsg->dwData1, pmsg->dwData2);	//����ε���,����,�ð�
		}
		break;
...
void CGuildManager::AddMemberResult(CPlayer* pTarget, DWORD MasterIdx)
{
	...
	DeleteMunhaJoinInfo(pTarget->GetID());	// magi82 - ���ϻ�����(070125)
}
...
void CGuildManager::ChangeMemberRank(CPlayer* pMaster, DWORD MemberIdx, BYTE Rank)
{
	...
	if( tRank < GUILD_MEMBER && Rank >= GUILD_MEMBER )	//���� ���Ŀ����� ����
	{
	...
	else if( tRank >= GUILD_MEMBER && Rank < GUILD_MEMBER )
	{
		...
		if( tLevel >= GUILD_STUDENT_MAX_LEVEL)	//40���� �̻��̰ų�
		{
...
{
	CGuild* pGuild = GetGuild(pPlayer->GetGuildIdx());
	MONEYTYPE maxmon = pPlayer->GetMaxPurseMoney(eItemTable_Inventory); //�κ��丮�� �� �ű�ϱ�.
...
void CGuildManager::AddStudentSyn( CPlayer* pMaster, DWORD TargetPlayerID )
{
	...
	if( SIEGEWARMGR->GetSiegeMapNum() == g_pServerSystem->GetMapNum() )	//������ ���̰ų�
	{
		OnErr(pMaster, MP_GUILD_ADDSTUDENT_NACK, eGuildErr_Err);
	}

	if(pMaster->GetGuildMemberRank() < GUILD_SENIOR)	//��� ������ �����̰ų�
	{
	...
	{
		if(pTarget->GetGuildIdx())	//��� ĳ���Ͱ� �̹� ���� �Ҽ��̰ų�
		{
			OnErr(pMaster, MP_GUILD_ADDSTUDENT_NACK, eGuildErr_AddMember_OtherGuild);
		}

		if(pTarget->GetLevel() >= GUILD_STUDENT_MAX_LEVEL)	//40���� �̻��̰ų�
		{
			OnErr(pMaster, MP_GUILD_ADDSTUDENT_NACK, eGuildErr_AddStudent_TooHighLevelAsStudent);
		}
	}
	...
	if( pGuild )
	{
		if( TRUE == pGuild->IsMember(TargetPlayerID) )	//�̹� ��� �Ҽ��̰ų�	//[��� ĳ���Ͱ� �̹� ���� �Ҽ��̰ų�] ������ üũ �ߺ�.
		{
		...
		//if( CanEntryGuildForStudent(pTarget->GetGuildCanEntryDate()) == FALSE )	//Ż���� �Ϸ簡 ������ �ʾҰų�
		//{
