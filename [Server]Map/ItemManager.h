...
public:
	BOOL FindItem(WORD ItemIdx)
	{
		...
		while(DealerItem* pItem = m_DealItemList.GetNextPos(pos) )
		{
			...
			if(pItem->ItemIdx == ItemIdx && pItem->ItemCount != 0)	// -1 : ������		1~5 : ���� ī��Ʈ�ٿ�(���λ󿡼��� ����)
				return TRUE;
		}
...
private:
	...
	CYHHashTable<SET_ITEM_OPTION>	m_SetItemOptionList; ///// 2007. 6. 8. CBH - ��Ʈ������ ���� ����Ʈ �߰�
...
public:
	...
	BOOL CheckWeaponToShopItem(CPlayer* pPlayer, WORD wItemIndex); //2007. 10. 15. CBH - ���� �ƹ�Ÿ ������ ���� ���� �Լ� �߰�
