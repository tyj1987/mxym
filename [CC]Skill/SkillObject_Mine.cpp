...
{	
	...
	CTargetListIterator riter(pTList);				// ���ڷ� �Ѿ�� ��� ����Ʈ iterator
	CTargetListIterator siter(&msg.TargetList);		// �޼����� ���� �����͸� ������ ����Ʈ iterator
...
{
	if(m_bOperate == TRUE)		// �̹� �۵������� return;
		return TRUE;
	if(gCurTime - m_SkillObjectInfo.StartTime < m_pSkillInfo->GetSkillInfo()->MineCheckStartTime)	// ���ڴ� �۵� �ð��� �ִ�.
		return TRUE;
