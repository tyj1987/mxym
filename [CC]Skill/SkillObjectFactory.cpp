...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->UpAttDefence[11] > 0.000001f || pInfo->UpPhyDefence[11] > 0.000001f)		// ���� ���
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->UpPhyAttack[11] > 0.000001f)		// �������ݷ� ���
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->CounterAttAttack[11] > 0.000001f || pInfo->CounterPhyAttack[11] > 0.000001f)	// �ݰ�
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->ChangeSpeedType == 1)		// �̵��ӵ� ��ȭ
	{
		//����üũ
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->VampiricLife[11] > 0.000001f || pInfo->VampiricNaeryuk[11] > 0.000001f)		// ����
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->DownAttDefence[11] > 0.000001f || pInfo->DownPhyDefence[11] > 0.000001f )		// ���� ����
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->DownPhyAttack[11] > 0.000001f)		// �������ݷ� ����
	{
...
//		SKsize += sizeof(CSkillObjectStateUnit_StatusAttach);
	...
	if(pInfo->DamageRate[11] > 0.000001f)		// ������ ������
	{
	...
	if(pInfo->AttackRate[11] > 0.000001f)		// ���� ������ ����
	{
