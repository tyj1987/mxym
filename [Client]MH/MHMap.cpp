...
void CMHMap::ToggleSunPosForShadow( BOOL bTitan )
{
	...
	if( bTitan )
	{
		m_SunPosForShadow = mapDesc->SunPos / dist * 2200;	//�Ÿ��� õ? //�ݰ溸�� ª�ƾ�?
...
{
	if(dwMapNum == 0)
		dwMapNum = m_MapNum;	// m_MapNum ���� ���� �ڽ��� �ִ� ���� ��ȣ�� �ִ�.
...
BOOL CMHMap::IsMapSame(DWORD dwMapKind, DWORD dwMapNum)
{
	...
	DWORD MapKind = pInfo->dwMapStateBItFlag;	// ��ũ��Ʈ ���� ��Ʈ�÷���
	DWORD CurMap = dwMapKind;	// üũ�ؾ��� ��Ʈ�÷���

	DWORD nHighBit = MapKind & CurMap;	// ���� ��Ʈ
	DWORD nSubBit = MapKind - CurMap;	// ���� ��Ʈ�� �� ������(������Ʈ ����)
	DWORD CheckFlag = 0x000003F;	// ������Ʈ üũ�� ���� �÷���
