...
//#include "../TitanMugongMixDlg.h"	// magi82 - Titan(070611) Ÿ��ź ������ȯ �ּ�ó��
...
#include "../StallFindDlg.h"	// �����˻� �߰� by Stiner(8)
...
cWindow * cScriptManager::GetDlgInfoFromFile(char * filePath, char* mode)
{
	...
	while(1)
	{
		...
		////////// 2007. 5. 18. CBH - Parse Type List ���� ó�� �߰� /////////
		PARSE_TYPE eParseType = GetParseType(buff);		
		////////////////////////////////////////////////////////////////

		{			
			////////////////////////////////////////////////////////////////
			/// 2007. 5. 21. CBH - CMD_ST, CMD_CS -> swich, case ������ ����   ///
			////////////////////////////////////////////////////////////////
			switch(eParseType)
			{
			case eDLG:
...
/////////////////// 2007. 5. 18. CBH - Parse Type ���� �Լ� �߰� ///////////////
BOOL cScriptManager::InitParseTypeData()
{
	int nMaxNum = eMAX_PARSETYPE_NUM;

	m_ParseTypeTable.Initialize(nMaxNum); //ParseType���� ���̺� �ʱ�ȭ
