...
BOOL CGameResourceManager::LoadKyunggongInfoList()
{
	...
	while(1)
	{
		...
		pInfo->KyungGongIdx = file.GetWord();		//���� index
		file.GetString(pInfo->KyungGongName);		//����̸�
		pInfo->NeedNaeRyuk = file.GetWord();		//�Ҹ� ����
		pInfo->MoveType = file.GetWord();			//�̵� Ÿ��
		pInfo->Speed = file.GetFloat();			//�̵� �ӵ�
		pInfo->ChangeTime = file.GetWord();		//��� ��� ��ȯ �ð�
		pInfo->StartEffect = file.GetWord();		//��� ��� ����
		pInfo->IngEffect = file.GetWord();			//��� ���� ����
		pInfo->EndEffect = file.GetWord();			//��� �� ����
...
//		pList->SkillInfo[1]				= SKILLMGR->GetSkillInfo((WORD)pList->AttackIndex[1]);
		...
		pList->ItemListNum1				= file.GetWord();// �ش�����۸���Ʈǥ��ȣ	
		pList->ItemListNum2				= file.GetWord();// �ش�����۸���Ʈǥ��ȣ	
		pList->ItemListNum3				= file.GetWord();// �ش�����۸���Ʈǥ��ȣ	
